...
export default function Home() {
  return (
    <div className='flex h-screen w-full items-center justify-center align-middle'>
      <div className='bg-white w-1/3 h-auto rounded-lg'>
        <div className='flex flex-col text-black'>
          ...
          <div className='p-5'>
            ...
            <input type="password" id="password" className="text-sm rounded-lg block w-full h-12 p-2.5 bg-gray-600 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="******" required />
          </div>
        </div>
